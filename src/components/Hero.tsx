...
const Hero = () => {
  ...
  return (
    <div className="bg-[#f7f2e9] min-h-[calc(100vh-80px)]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button
                className="bg-[#333333] hover:bg-[#222222] text-white px-8 py-6 rounded-full text-lg h-auto"
              >
                Order Now
              </Button>
              <Button
                variant="ghost"
                className="flex items-center justify-center gap-2 text-lg h-auto py-6"
              >
          ...
          <div className="relative flex justify-center">
            <img
              src="/lovable-uploads/7cb76421-ac2a-4fde-b0df-3d8dad19602a.png"
              alt="Food Delivery"
